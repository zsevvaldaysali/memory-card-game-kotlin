...
import com.daysali.memcardgame_ktln.databinding.ActivityCokluPlayerGame4vs4Binding
...
class CokluPlayerGame4vs4 : AppCompatActivity() {
    private lateinit var database: DatabaseReference
    private lateinit var imgButtonlar: List<ImageButton>
    private lateinit var binding: ActivityCokluPlayerGame4vs4Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityCokluPlayerGame4vs4Binding.inflate(layoutInflater)
        ...
        var sound = MediaPlayer.create(this@CokluPlayerGame4vs4,R.raw.prologue)
        sound.start()
        ...
        fun playCongratulationsSound() {
            sound = MediaPlayer.create(this@CokluPlayerGame4vs4, R.raw.congratulations)
            sound!!.start()
        }
        ...
        fun playShockedSound() {
            if (sound == null) {
                sound = MediaPlayer.create(this@CokluPlayerGame4vs4, R.raw.shocked)
                sound!!.start()
            } else sound!!.start()
        }
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                var sureTut = object : CountDownTimer(60000, 1000) {
                    ...
                    override fun onFinish() {
                        stopSound()
                        playShockedSound()
                        Toast.makeText(this@CokluPlayerGame4vs4, "Süreniz sona ermiştir!", Toast.LENGTH_SHORT).show()
