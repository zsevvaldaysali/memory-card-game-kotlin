...
import com.daysali.memcardgame_ktln.databinding.ActivitySinglePlayerGame4vs4Binding
...
class SinglePlayerGame4vs4 : AppCompatActivity() {
    private lateinit var database: DatabaseReference
    private lateinit var binding: ActivitySinglePlayerGame4vs4Binding
    private lateinit var imgButtonlar: List<ImageButton>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySinglePlayerGame4vs4Binding.inflate(layoutInflater)
        ...
        var sound = MediaPlayer.create(this@SinglePlayerGame4vs4, R.raw.prologue)
        sound.start()
        ...
        fun playCongratulationsSound() {
            sound = MediaPlayer.create(this@SinglePlayerGame4vs4, R.raw.congratulations)
            sound!!.start()
        }
        ...
        fun playShockedSound() {
            if (sound == null) {
                sound = MediaPlayer.create(this@SinglePlayerGame4vs4, R.raw.shocked)
                sound!!.start()
            } else sound!!.start()
        }
        // 2. Pause playback
        ...
        val card_Listener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                resimler.forEach {
                    if(grfndr_say < 2){
                        ...
                        if(it.house.toString() == ev_grfndr)
                        {
                ...
                val sureTut = object : CountDownTimer(45000, 1000) {
                    ...
                    override fun onFinish() {
                        stopSound()
                        playShockedSound()
                        Toast.makeText(this@SinglePlayerGame4vs4, "Süreniz sona ermiştir!", Toast.LENGTH_SHORT).show()
                ...
                fun eslesmeControl(kontrol1:Int, kontrol2:Int){
                    ...
                    if(ekrandaki_resimler[kontrol1].name.toString() == ekrandaki_resimler[kontrol2].name.toString()){
                        ...
                        sound = MediaPlayer.create(this@SinglePlayerGame4vs4, R.raw.victory)
                        sound!!.start()
            ...
            override fun onCancelled(error: DatabaseError) {
                Log.w("firebase","hata",error.toException())
            }
